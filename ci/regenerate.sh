...
with="$with,wasi:cli/exit@0.2.0=crate::cli::exit"
with="$with,wasi:cli/stdin@0.2.0=crate::cli::stdin"
with="$with,wasi:cli/stdout@0.2.0=crate::cli::stdout"
with="$with,wasi:cli/stderr@0.2.0=crate::cli::stderr"
with="$with,wasi:cli/terminal-input@0.2.0=crate::cli::terminal_input"
with="$with,wasi:cli/terminal-output@0.2.0=crate::cli::terminal_output"
with="$with,wasi:cli/terminal-stdin@0.2.0=crate::cli::terminal_stdin"
with="$with,wasi:cli/terminal-stdout@0.2.0=crate::cli::terminal_stdout"
with="$with,wasi:cli/terminal-stderr@0.2.0=crate::cli::terminal_stderr"
...
with="$with,wasi:filesystem/types@0.2.0=crate::filesystem::types"
with="$with,wasi:filesystem/preopens@0.2.0=crate::filesystem::preopens"
...
with="$with,wasi:random/insecure@0.2.0=crate::random::insecure"
with="$with,wasi:random/insecure-seed@0.2.0=crate::random::insecure_seed"
with="$with,wasi:sockets/network@0.2.0=crate::sockets::network"
with="$with,wasi:sockets/instance-network@0.2.0=crate::sockets::instance_network"
with="$with,wasi:sockets/tcp@0.2.0=crate::sockets::tcp"
with="$with,wasi:sockets/tcp-create-socket@0.2.0=crate::sockets::tcp_create_socket"
with="$with,wasi:sockets/udp@0.2.0=crate::sockets::udp"
with="$with,wasi:sockets/udp-create-socket@0.2.0=crate::sockets::udp_create_socket"
with="$with,wasi:sockets/ip-name-lookup@0.2.0=crate::sockets::ip_name_lookup"
