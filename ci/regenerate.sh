...
generate() {
  file="$1"
  shift
  wit-bindgen rust wit --out-dir src "$@" --format \
...
with="$with,wasi:clocks/wall-clock@0.3.0-rc-2025-08-15=crate::clocks::wall_clock"
with="$with,wasi:random/random@0.3.0-rc-2025-08-15=crate::random::random"
with="$with,wasi:http/types@0.3.0-rc-2025-08-15=crate::http::types"
with="$with,wasi:http/handler@0.3.0-rc-2025-08-15=crate::http::handler"
