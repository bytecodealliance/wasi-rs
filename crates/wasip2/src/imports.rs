...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.60.0:wasi:cli@0.2.12:imports:encoded worldrust-wasip2-1.0.4+wasi-0.2.12-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.60.0:wasi:cli@0.2.12:imports:encoded worldrust-wasip2-1.0.4+wasi-0.2.12-from-crates-io"))]
...
orts\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.254.0\
\x10wit-bindgen-rust\x060.60.0";
#[inline(never)]
#[doc(hidden)]
