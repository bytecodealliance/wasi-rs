...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.2.12:imports:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.2.12:imports:encoded worldrust-wasip2-1.0.3+wasi-0.2.9-from-crates-io"))]
