...
//   * type_section_suffix: "rust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-proxy-world"
...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        (link_section =
        "component-type:wit-bindgen:0.62.0:wasi:http@0.2.12:proxy:imports and exportsrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-proxy-world")]
...
259.0\x10wit-bindgen-rust\x060.62.0";
        };
    };
}
#[doc(inline)]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:http@0.2.12:proxy-with-all-of-its-exports-removed:encoded worldrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-proxy-world-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:http@0.2.12:proxy-with-all-of-its-exports-removed:encoded worldrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-proxy-world"))]
...
\x01\x0cprocessed-by\x02\x0dwit-component\x070.259.0\x10wit-bindgen-rust\x060.62\
.0";
#[inline(never)]
#[doc(hidden)]
