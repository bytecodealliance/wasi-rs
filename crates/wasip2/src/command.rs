...
//   * type_section_suffix: "rust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-command-world"
...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.62.0:wasi:cli@0.2.12:command:imports and exportsrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-command-world")]
...
9.0\x10wit-bindgen-rust\x060.62.0";
        };
    };
}
#[doc(inline)]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:cli@0.2.12:command-with-all-of-its-exports-removed:encoded worldrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-command-world-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:cli@0.2.12:command-with-all-of-its-exports-removed:encoded worldrust-wasip2-2.0.0+wasi-0.2.12-from-crates-io-command-world"))]
...
ers\x01\x0cprocessed-by\x02\x0dwit-component\x070.259.0\x10wit-bindgen-rust\x060\
.62.0";
#[inline(never)]
#[doc(hidden)]
