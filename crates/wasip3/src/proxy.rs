...
//   * type_section_suffix: "rust-wasip3-0.3.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world"
...
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::cli::types as __with_name1;
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::cli::stdout as __with_name2;
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::cli::stderr as __with_name3;
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::cli::stdin as __with_name4;
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::clocks::types as __with_name5;
#[allow(unfulfilled_lint_expectations, unused_imports)]
use crate::clocks::monotonic_clock as __with_name6;
#[allow(unfulfilled_lint_expectations, unused_imports)]
...
pub mod wasi {
    pub mod http {
        ...
        pub mod types {
            ...
            pub type Duration = super::super::super::__with_name6::Duration;
            ...
            unsafe impl _rt::WasmResource for Fields {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[link(wasm_import_module = "wasi:http/types@0.3.0-rc-2025-09-16")]
                    unsafe extern "C" {
            ...
            impl Fields {
                ...
                pub fn new() -> Self {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(
                            wasm_import_module = "wasi:http/types@0.3.0-rc-2025-09-16"
                        )]
                        unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:http/handler@0.3.0-rc-2025-09-16"
                            )]
                            unsafe extern "C" {
                                #[link_name = "[async-lower]handle"]
    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod handler {
                ...
                pub unsafe fn _export_handle_cabi<T: Guest>(arg0: i32) -> i32 {
                    unsafe {
                        ...
                        wit_bindgen::rt::async_support::start_task(async move {
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "[export]wasi:http/handler@0.3.0-rc-2025-09-16"
                            )]
                            unsafe extern "C" {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_wasi_http_handler_0_3_0_rc_2025_09_16_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "[async-lift]wasi:http/handler@0.3.0-rc-2025-09-16#handle")]
                        unsafe extern "C" fn export_handle(arg0 : i32,) -> i32 { unsafe {
                        $($path_to_types)*:: _export_handle_cabi::<$ty > (arg0) } }
                        #[unsafe (export_name =
                        "[callback][async-lift]wasi:http/handler@0.3.0-rc-2025-09-16#handle")]
                ...
                #[doc(hidden)]
                pub use __export_wasi_http_handler_0_3_0_rc_2025_09_16_cabi;
            }
        }
    }
}
...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::http::handler::__export_wasi_http_handler_0_3_0_rc_2025_09_16_cabi!($ty
        ...
        "component-type:wit-bindgen:0.48.0:wasi:http@0.3.0-rc-2025-09-16:proxy:imports and exportsrust-wasip3-0.3.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world")]
        #[doc(hidden)] #[allow(clippy::octal_escapes)] pub static
        __WIT_BINDGEN_COMPONENT_TYPE : [u8; 4922] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbe%\x01A\x02\x01A\x1c\
...
/stdout@0.3.0-rc-2025-09-16\x05\x03\x01B\x06\x02\x03\x02\x01\x02\x04\0\x0aerror-\
code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01C\x01\x04data\x02\0\x03\x04\0\x10write-\
via-stream\x01\x04\x03\0#wasi:cli/stderr@0.3.0-rc-2025-09-16\x05\x04\x01B\x08\x02\
\x03\x02\x01\x02\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\
\x01o\x02\x02\x04\x01@\0\0\x05\x04\0\x0fread-via-stream\x01\x06\x03\0\"wasi:cli/\
stdin@0.3.0-rc-2025-09-16\x05\x05\x01B\x02\x01w\x04\0\x08duration\x03\0\0\x03\0%\
wasi:clocks/types@0.3.0-rc-2025-09-16\x05\x06\x02\x03\0\x05\x08duration\x01B\x0c\
\x02\x03\x02\x01\x07\x04\0\x08duration\x03\0\0\x01w\x04\0\x07instant\x03\0\x02\x01\
@\0\0\x03\x04\0\x03now\x01\x04\x01@\0\0\x01\x04\0\x0eget-resolution\x01\x05\x01C\
\x01\x04when\x03\x01\0\x04\0\x0await-until\x01\x06\x01C\x01\x08how-long\x01\x01\0\
\x04\0\x08wait-for\x01\x07\x03\0/wasi:clocks/monotonic-clock@0.3.0-rc-2025-09-16\
\x05\x08\x02\x03\0\x06\x08duration\x01B\x84\x01\x02\x03\x02\x01\x09\x04\0\x08dur\
...
error-code\x03\0\x12\x01q\x03\x0einvalid-syntax\0\0\x09forbidden\0\0\x09immutabl\
e\0\0\x04\0\x0cheader-error\x03\0\x14\x01q\x02\x0dnot-supported\0\0\x09immutable\
\0\0\x04\0\x15request-options-error\x03\0\x16\x01s\x04\0\x0afield-name\x03\0\x18\
\x01p}\x04\0\x0bfield-value\x03\0\x1a\x04\0\x06fields\x03\x01\x04\0\x07headers\x03\
\0\x1c\x04\0\x08trailers\x03\0\x1c\x04\0\x07request\x03\x01\x04\0\x0frequest-opt\
ions\x03\x01\x01{\x04\0\x0bstatus-code\x03\0!\x04\0\x08response\x03\x01\x01i\x1c\
\x01@\0\0$\x04\0\x13[constructor]fields\x01%\x01o\x02\x19\x1b\x01p&\x01j\x01$\x01\
\x15\x01@\x01\x07entries'\0(\x04\0\x18[static]fields.from-list\x01)\x01h\x1c\x01\
p\x1b\x01@\x02\x04self*\x04name\x19\0+\x04\0\x12[method]fields.get\x01,\x01@\x02\
\x04self*\x04name\x19\0\x7f\x04\0\x12[method]fields.has\x01-\x01j\0\x01\x15\x01@\
...
\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x06handle\x01\x09\x03\0%wasi:http/h\
andler@0.3.0-rc-2025-09-16\x05\x0e\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\
\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0eget-resolu\
tion\x01\x02\x03\0*wasi:clocks/wall-clock@0.3.0-rc-2025-09-16\x05\x0f\x01B\x0b\x02\
\x03\x02\x01\x0b\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x0c\x04\0\x08response\x03\
\0\x02\x02\x03\x02\x01\x0d\x04\0\x0aerror-code\x03\0\x04\x01i\x01\x01i\x03\x01j\x01\
\x07\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x06handle\x01\x09\x04\0%wasi:ht\
tp/handler@0.3.0-rc-2025-09-16\x05\x10\x04\0#wasi:http/proxy@0.3.0-rc-2025-09-16\
\x04\0\x0b\x0b\x01\0\x05proxy\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0d\
wit-component\x070.241.2\x10wit-bindgen-rust\x060.48.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.48.0:wasi:http@0.3.0-rc-2025-09-16:proxy-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.3.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4846] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd2$\x01A\x02\x01A\x1a\
\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\0w\
\x04\0\x0eget-random-u64\x01\x02\x03\0&wasi:random/random@0.3.0-rc-2025-09-16\x05\
\0\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\
\0\0\x03\0\"wasi:cli/types@0.3.0-rc-2025-09-16\x05\x01\x02\x03\0\x01\x0aerror-co\
...
andler@0.3.0-rc-2025-09-16\x05\x0e\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\
\x04\0\x08datetime\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0eget-resolu\
tion\x01\x02\x03\0*wasi:clocks/wall-clock@0.3.0-rc-2025-09-16\x05\x0f\x04\0Cwasi\
:http/proxy-with-all-of-its-exports-removed@0.3.0-rc-2025-09-16\x04\0\x0b+\x01\0\
%proxy-with-all-of-its-exports-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-\
by\x02\x0dwit-component\x070.241.2\x10wit-bindgen-rust\x060.48.0";
#[inline(never)]
#[doc(hidden)]
