...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.46.0:wasi:http@0.3.0-rc-2025-08-15:proxy:imports and exportsrust-wasip3-0.1.1+wasi-0.3.0-rc-2025-08-15-from-crates-io-proxy-world")]
...
producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.239.0\x10wit-bindgen-rus\
t\x060.46.0";
        };
    };
}
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.46.0:wasi:http@0.3.0-rc-2025-08-15:proxy-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.1.1+wasi-0.3.0-rc-2025-08-15-from-crates-io-proxy-world"
)]
#[doc(hidden)]
...
\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.239.0\x10wit-bindgen\
-rust\x060.46.0";
#[inline(never)]
#[doc(hidden)]
