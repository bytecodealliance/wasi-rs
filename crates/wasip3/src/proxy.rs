...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.45.0:wasi:http@0.3.0-rc-2025-08-15:proxy:imports and exportsrust-wasi-from-crates-io-proxy-world")]
...
producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.238.0\x10wit-bindgen-rus\
t\x060.45.0";
        };
    };
}
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.45.0:wasi:http@0.3.0-rc-2025-08-15:proxy-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-proxy-world"
)]
#[doc(hidden)]
