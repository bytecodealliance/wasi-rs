...
//   * type_section_suffix: "rust-wasip3-0.2.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world"
            ...
            pub mod handler {
                ...
                macro_rules! __export_wasi_http_handler_0_3_0_rc_2025_09_16_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        "[async-lift]wasi:http/handler@0.3.0-rc-2025-09-16#[async]handle")]
                        unsafe extern "C" fn export_async_handle(arg0 : i32,) -> i32 {
                        unsafe { $($path_to_types)*:: _export_async_handle_cabi::<$ty >
                        (arg0) } } #[unsafe (export_name =
                        "[callback][async-lift]wasi:http/handler@0.3.0-rc-2025-09-16#[async]handle")]
...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.46.0:wasi:http@0.3.0-rc-2025-09-16:proxy:imports and exportsrust-wasip3-0.2.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world")]
        #[doc(hidden)] #[allow(clippy::octal_escapes)] pub static
        __WIT_BINDGEN_COMPONENT_TYPE : [u8; 4964] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xe8%\x01A\x02\x01A\x1c\
...
-resolution\x01\x02\x03\0*wasi:clocks/wall-clock@0.3.0-rc-2025-09-16\x05\x0f\x01\
B\x0b\x02\x03\x02\x01\x0b\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x0c\x04\0\x08\
response\x03\0\x02\x02\x03\x02\x01\x0d\x04\0\x0aerror-code\x03\0\x04\x01i\x01\x01\
i\x03\x01j\x01\x07\x01\x05\x01@\x01\x07request\x06\0\x08\x04\0\x0d[async]handle\x01\
\x09\x04\0%wasi:http/handler@0.3.0-rc-2025-09-16\x05\x10\x04\0#wasi:http/proxy@0\
.3.0-rc-2025-09-16\x04\0\x0b\x0b\x01\0\x05proxy\x03\0\0\0G\x09producers\x01\x0cp\
rocessed-by\x02\x0dwit-component\x070.239.0\x10wit-bindgen-rust\x060.46.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.46.0:wasi:http@0.3.0-rc-2025-09-16:proxy-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.2.0+wasi-0.3.0-rc-2025-09-16-from-crates-io-proxy-world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 4881] = *b"\
