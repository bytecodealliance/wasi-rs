...
pub mod wit_future {
    ...
    pub mod vtable1 {
        ...
        > {
            ...
            drop_readable,
            dealloc_lists,
            layout: unsafe { ::std::alloc::Layout::from_size_align_unchecked(20, 4) },
            lift,
            lower,
            new,
            start_read,
...
pub mod wit_stream {
    ...
    pub mod vtable1 {
        ...
        > {
            ...
            layout: unsafe { ::std::alloc::Layout::from_size_align_unchecked(24, 4) },
            lift: Some(lift),
            lower: Some(lower),
            new,
            start_read,
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.54.0:wasi:cli@0.3.0-rc-2026-03-15:imports:encoded worldrust-wasip3-0.5.0+wasi-0.3.0-rc-2026-03-15-from-crates-io"
)]
#[doc(hidden)]
