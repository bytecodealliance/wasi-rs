...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.6.0+wasi-0.3.0-rc-2026-03-15-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.6.0+wasi-0.3.0-rc-2026-03-15-from-crates-io"))]
...
it-component\x070.251.0\x10wit-bindgen-rust\x060.58.0";
#[inline(never)]
#[doc(hidden)]
