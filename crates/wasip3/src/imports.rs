...
// Options used:
//   * std_feature
//   * type_section_suffix: "rust-wasip3-0.9.0+wasi-0.3.0-from-crates-io"
#[rustfmt::skip]
...
pub mod wasi {
    pub mod cli {
        ...
        pub mod environment {
            ...
            #[allow(async_fn_in_trait)]
            pub fn get_initial_cwd() -> ::core::option::Option<_rt::String> {
                unsafe {
                    #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                    #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                    struct RetArea(
    ...
    pub mod filesystem {
        ...
        pub mod types {
            ...
            pub enum DescriptorType {
                ...
                Other(::core::option::Option<_rt::String>),
            }
            ...
            pub struct DescriptorStat {
                ...
                pub data_access_timestamp: ::core::option::Option<Instant>,
                /// Last data modification timestamp.
                ///
                /// If the `option` is none, the platform doesn't maintain a
                /// modification timestamp for this file.
                pub data_modification_timestamp: ::core::option::Option<Instant>,
                /// Last file status-change timestamp.
                ///
                /// If the `option` is none, the platform doesn't maintain a
                /// status-change timestamp for this file.
                pub status_change_timestamp: ::core::option::Option<Instant>,
            }
                ...
                pub async fn advise(
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            type Results = ::core::result::Result<(), ErrorCode>;
                            type ParamsLower = ParamsLower;
                            fn abi_layout(&mut self) -> ::core::alloc::Layout {
                                unsafe {
            ...
            impl Descriptor {
                ...
                #[allow(async_fn_in_trait)]
                pub async fn sync_data(&self) -> ::core::result::Result<(), ErrorCode> {
                    unsafe {
                        #[derive(Copy, Clone)]
            ...
            impl Descriptor {
                ...
                pub async fn get_flags(
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            type Params = (&'a Descriptor,);
                            type Results = ::core::result::Result<
                                DescriptorFlags,
                                ErrorCode,
                            >;
                            type ParamsLower = ParamsLower;
            ...
            impl Descriptor {
                ...
                #[allow(async_fn_in_trait)]
                pub async fn sync(&self) -> ::core::result::Result<(), ErrorCode> {
                    unsafe {
                        #[derive(Copy, Clone)]
                        struct ParamsLower(i32);
                        unsafe impl Send for ParamsLower {}
                ...
                pub async fn open_at(
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            ...
                            type Results = ::core::result::Result<Descriptor, ErrorCode>;
                            type ParamsLower = ParamsLower;
                            fn abi_layout(&mut self) -> ::core::alloc::Layout {
                                unsafe {
                                    ::core::alloc::Layout::from_size_align_unchecked(
    ...
    pub mod sockets {
        ...
        pub mod types {
            ...
            impl TcpSocket {
                ...
                /// - `invalid-argument`:     (set) The provided value was 0.
                #[allow(async_fn_in_trait)]
                pub fn get_keep_alive_interval(
                    &self,
                ) -> ::core::result::Result<Duration, ErrorCode> {
                    unsafe {
                        #[repr(align(8))]
            ...
            impl TcpSocket {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_hop_limit(&self) -> ::core::result::Result<u8, ErrorCode> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
            ...
            impl UdpSocket {
                ...
                /// - <https://man.freebsd.org/cgi/man.cgi?connect>
                #[allow(async_fn_in_trait)]
                pub fn disconnect(&self) -> ::core::result::Result<(), ErrorCode> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
                    ...
                    unsafe {
                        ...
                        unsafe impl<'a> _Subtask for _MySubtask<'a> {
                            type Params = (
                                &'a UdpSocket,
                                _rt::Vec<u8>,
                                ::core::option::Option<IpSocketAddress>,
                            );
                            type Results = ::core::result::Result<(), ErrorCode>;
                            type ParamsLower = ParamsLower;
                            fn abi_layout(&mut self) -> ::core::alloc::Layout {
            ...
            impl UdpSocket {
                ...
                pub async fn receive(
                    &self,
                ) -> ::core::result::Result<(_rt::Vec<u8>, IpSocketAddress), ErrorCode> {
                    unsafe {
                        #[derive(Copy, Clone)]
                        struct ParamsLower(i32);
                        unsafe impl Send for ParamsLower {}
        ...
        pub mod ip_name_lookup {
            ...
            pub async fn resolve_addresses(
                name: _rt::String,
            ) -> ::core::result::Result<_rt::Vec<IpAddress>, ErrorCode> {
                unsafe {
                    #[derive(Copy, Clone)]
...
pub mod wit_future {
    ...
    pub mod vtable0 {
        ...
        mod imports {
            ...
            unsafe extern "C" {
                ...
                pub(super) fn start_read(_: u32, _: *mut u8) -> u32;
                #[link_name = "[async-lower][future-write-1]read-via-stream"]
                pub(super) fn start_write(_: u32, _: *const u8) -> u32;
            }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn new() -> u64 {
        ...
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn cancel_write(handle: u32) -> u32 {
            unsafe { imports::cancel_write(handle) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn cancel_read(handle: u32) -> u32 {
            unsafe { imports::cancel_read(handle) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn drop_writable(handle: u32) {
            unsafe { imports::drop_writable(handle) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn drop_readable(handle: u32) {
            unsafe { imports::drop_readable(handle) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn start_read(handle: u32, ptr: *mut u8) -> u32 {
            unsafe { imports::start_read(handle, ptr) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn start_write(handle: u32, ptr: *const u8) -> u32 {
            unsafe { imports::start_write(handle, ptr) }
        }
        unsafe fn lift(
            ptr: *mut u8,
        ) -> ::core::result::Result<(), super::super::wasi::cli::stdin::ErrorCode> {
            unsafe {
        ...
        unsafe fn lower(
            value: ::core::result::Result<(), super::super::wasi::cli::stdin::ErrorCode>,
            ptr: *mut u8,
        ) {
            unsafe {
                match value {
        ...
        for ::core::result::Result<(), super::super::wasi::cli::stdin::ErrorCode> {
    ...
    pub mod vtable1 {
        ...
        unsafe fn lift(
            ...
            (),
            super::super::wasi::filesystem::types::ErrorCode,
        > {
            unsafe {
                let l0 = i32::from(*ptr.add(0).cast::<u8>());
                match l0 {
        ...
        pub static VTABLE: wit_bindgen::rt::async_support::FutureVtable<
            ::core::result::Result<(), super::super::wasi::filesystem::types::ErrorCode>,
        > = wit_bindgen::rt::async_support::FutureVtable::<
            ::core::result::Result<(), super::super::wasi::filesystem::types::ErrorCode>,
        > {
            cancel_write,
    ...
    pub mod vtable2 {
        ...
        unsafe fn lift(
            ptr: *mut u8,
        ) -> ::core::result::Result<(), super::super::wasi::sockets::types::ErrorCode> {
            unsafe {
                let l0 = i32::from(*ptr.add(0).cast::<u8>());
                match l0 {
                    0 => {
        ...
        unsafe fn lower(
            value: ::core::result::Result<
                (),
                super::super::wasi::sockets::types::ErrorCode,
            >,
            ptr: *mut u8,
        ) {
            unsafe {
        ...
        impl super::FuturePayload
        for ::core::result::Result<(), super::super::wasi::sockets::types::ErrorCode> {
            const VTABLE: &'static wit_bindgen::rt::async_support::FutureVtable<Self> = &VTABLE;
        }
    }
    ...
    pub mod vtable0 {
        ...
        mod imports {
            ...
            unsafe extern "C" {
                ...
                pub(super) fn start_read(_: u32, _: *mut u8, _: usize) -> u32;
                #[link_name = "[async-lower][stream-write-0]read-via-stream"]
                pub(super) fn start_write(_: u32, _: *const u8, _: usize) -> u32;
            }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn new() -> u64 {
        ...
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn start_read(
            handle: u32,
            ptr: *mut u8,
            _extra: usize,
        ) -> u32 {
            unsafe { imports::start_read(handle, ptr, _extra) }
        }
        #[cfg(target_arch = "wasm32")]
        unsafe extern "C" fn start_write(
            ...
            unsafe { imports::start_write(handle, ptr, _extra) }
        }
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.9.0+wasi-0.3.0-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.9.0+wasi-0.3.0-from-crates-io"))]
...
it-component\x070.259.0\x10wit-bindgen-rust\x060.62.0";
#[inline(never)]
#[doc(hidden)]
