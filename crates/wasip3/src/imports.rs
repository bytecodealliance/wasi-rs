...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.60.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.1+wasi-0.3.0-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.60.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.1+wasi-0.3.0-from-crates-io"))]
...
it-component\x070.254.0\x10wit-bindgen-rust\x060.60.0";
#[inline(never)]
#[doc(hidden)]
