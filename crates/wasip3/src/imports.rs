...
// Options used:
//   * type_section_suffix: "rust-wasip3-0.2.0+wasi-0.3.0-rc-2025-09-16-from-crates-io"
#[rustfmt::skip]
        ...
        pub mod environment {
            ...
            pub fn get_environment() -> _rt::Vec<(_rt::String, _rt::String)> {
                unsafe {
                    ...
                    #[link(
                        wasm_import_module = "wasi:cli/environment@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod exit {
            ...
            pub fn exit(status: Result<(), ()>) -> () {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/exit@0.3.0-rc-2025-09-16")]
                    unsafe extern "C" {
                        #[link_name = "exit"]
        ...
        pub mod stdin {
            ...
            pub fn read_via_stream() -> (
                ...
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "wasi:cli/stdin@0.3.0-rc-2025-09-16")]
                    unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:cli/stdout@0.3.0-rc-2025-09-16"
                            )]
                            unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:cli/stderr@0.3.0-rc-2025-09-16"
                            )]
                            unsafe extern "C" {
                                #[link_name = "[async-lower][async]write-via-stream"]
                                fn call(_: i32, _: *mut u8) -> i32;
        ...
        pub mod terminal_input {
            ...
            unsafe impl _rt::WasmResource for TerminalInput {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:cli/terminal-input@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod terminal_output {
            ...
            unsafe impl _rt::WasmResource for TerminalOutput {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:cli/terminal-output@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod terminal_stdin {
            ...
            pub fn get_terminal_stdin() -> Option<TerminalInput> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:cli/terminal-stdin@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod terminal_stdout {
            ...
            pub fn get_terminal_stdout() -> Option<TerminalOutput> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:cli/terminal-stdout@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod terminal_stderr {
            ...
            pub fn get_terminal_stderr() -> Option<TerminalOutput> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:cli/terminal-stderr@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod wall_clock {
            ...
            pub fn now() -> Datetime {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:clocks/wall-clock@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
                        #[link_name = "now"]
                        fn wit_import1(_: *mut u8);
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Descriptor {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:filesystem/types@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod preopens {
            ...
            pub fn get_directories() -> _rt::Vec<(Descriptor, _rt::String)> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:filesystem/preopens@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod random {
            ...
            pub fn get_random_bytes(len: u64) -> _rt::Vec<u8> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:random/random@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod insecure {
            ...
            pub fn get_insecure_random_bytes(len: u64) -> _rt::Vec<u8> {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:random/insecure@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
        ...
        pub mod insecure_seed {
            ...
            pub fn get_insecure_seed() -> (u64, u64) {
                unsafe {
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:random/insecure-seed@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
          ...
          supported size."
            ...
            unsafe impl _rt::WasmResource for TcpSocket {
                ...
                unsafe fn drop(_handle: u32) {
                    #[cfg(target_arch = "wasm32")]
                    #[link(
                        wasm_import_module = "wasi:sockets/types@0.3.0-rc-2025-09-16"
                    )]
                    unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:sockets/ip-name-lookup@0.3.0-rc-2025-09-16"
                            )]
                            unsafe extern "C" {
...
pub mod wit_future {
    ...
    pub mod vtable1 {
        ...
        #[cfg(target_arch = "wasm32")]
        #[link(wasm_import_module = "wasi:filesystem/types@0.3.0-rc-2025-09-16")]
        unsafe extern "C" {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.46.0:wasi:cli@0.3.0-rc-2025-09-16:imports:encoded worldrust-wasip3-0.2.0+wasi-0.3.0-rc-2025-09-16-from-crates-io"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 8179] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf5>\x01A\x02\x01A2\x01\
...
/insecure-seed@0.3.0-rc-2025-09-16\x05\x1c\x04\0$wasi:cli/imports@0.3.0-rc-2025-\
09-16\x04\0\x0b\x0d\x01\0\x07imports\x03\0\0\0G\x09producers\x01\x0cprocessed-by\
\x02\x0dwit-component\x070.239.0\x10wit-bindgen-rust\x060.46.0";
#[inline(never)]
#[doc(hidden)]
