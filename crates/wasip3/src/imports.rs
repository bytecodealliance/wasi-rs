...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.45.0:wasi:cli@0.3.0-rc-2025-08-15:imports:encoded worldrust-wasi-from-crates-io"
)]
#[doc(hidden)]
...
essed-by\x02\x0dwit-component\x070.238.0\x10wit-bindgen-rust\x060.45.0";
#[inline(never)]
#[doc(hidden)]
