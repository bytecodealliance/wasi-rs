...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.58.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.7.0+wasi-0.3.0-from-crates-io"))]
