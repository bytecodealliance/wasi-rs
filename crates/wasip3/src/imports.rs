...
// Options used:
//   * std_feature
//   * type_section_suffix: "rust-wasip3-0.8.0+wasi-0.3.0-from-crates-io"
#[rustfmt::skip]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.61.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.8.0+wasi-0.3.0-from-crates-io-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.61.0:wasi:cli@0.3.0:imports:encoded worldrust-wasip3-0.8.0+wasi-0.3.0-from-crates-io"))]
