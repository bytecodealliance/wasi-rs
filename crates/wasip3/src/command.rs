...
// Options used:
//   * with "wasi:cli/environment@0.3.0-rc-2026-02-09" = "crate::cli::environment"
//   * with "wasi:cli/exit@0.3.0-rc-2026-02-09" = "crate::cli::exit"
...
//   * with "wasi:cli/terminal-input@0.3.0-rc-2026-02-09" = "crate::cli::terminal_input"
//   * with "wasi:cli/terminal-output@0.3.0-rc-2026-02-09" = "crate::cli::terminal_output"
//   * with "wasi:cli/terminal-stdin@0.3.0-rc-2026-02-09" = "crate::cli::terminal_stdin"
//   * with "wasi:cli/terminal-stdout@0.3.0-rc-2026-02-09" = "crate::cli::terminal_stdout"
//   * with "wasi:cli/terminal-stderr@0.3.0-rc-2026-02-09" = "crate::cli::terminal_stderr"
...
//   * with "wasi:filesystem/types@0.3.0-rc-2026-02-09" = "crate::filesystem::types"
//   * with "wasi:filesystem/preopens@0.3.0-rc-2026-02-09" = "crate::filesystem::preopens"
...
//   * with "wasi:sockets/types@0.3.0-rc-2026-02-09" = "crate::sockets::types"
//   * with "wasi:sockets/ip-name-lookup@0.3.0-rc-2026-02-09" = "crate::sockets::ip_name_lookup"
//   * type_section_suffix: "rust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-command-world"
    ...
    pub mod wasi {
        pub mod cli {
            ...
            pub mod run {
                ...
                pub unsafe fn _export_run_cabi<T: Guest>() -> i32 {
                    unsafe {
                        ...
                        wit_bindgen::rt::async_support::start_task(async move {
                            ...
                            #[link(
                                wasm_import_module = "[export]wasi:cli/run@0.3.0-rc-2026-02-09"
                            )]
                            unsafe extern "C" {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_wasi_cli_run_0_3_0_rc_2026_02_09_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "[async-lift]wasi:cli/run@0.3.0-rc-2026-02-09#run")] unsafe
                ...
                #[doc(hidden)]
                pub use __export_wasi_cli_run_0_3_0_rc_2026_02_09_cabi;
            }
        }
    }
}
...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::cli::run::__export_wasi_cli_run_0_3_0_rc_2026_02_09_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::wasi::cli::run); const _ : () =
        { #[rustfmt::skip] #[cfg(target_arch = "wasm32")] #[unsafe (link_section =
        "component-type:wit-bindgen:0.53.0:wasi:cli@0.3.0-rc-2026-02-09:command:imports and exportsrust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-command-world")]
        #[doc(hidden)] #[allow(clippy::octal_escapes)] pub static
        __WIT_BINDGEN_COMPONENT_TYPE : [u8; 8048] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xf2=\x01A\x02\x01A3\x01\
...
/insecure-seed@0.3.0-rc-2026-02-09\x05\x1b\x01B\x03\x01j\0\0\x01C\0\0\0\x04\0\x03\
run\x01\x01\x04\0\x20wasi:cli/run@0.3.0-rc-2026-02-09\x05\x1c\x04\0$wasi:cli/com\
mand@0.3.0-rc-2026-02-09\x04\0\x0b\x0d\x01\0\x07command\x03\0\0\0G\x09producers\x01\
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.53.0:wasi:cli@0.3.0-rc-2026-02-09:command-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-command-world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 8055] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd9=\x01A\x02\x01A1\x01\
B\x0a\x01o\x02ss\x01p\0\x01@\0\0\x01\x04\0\x0fget-environment\x01\x02\x01ps\x01@\
\0\0\x03\x04\0\x0dget-arguments\x01\x04\x01ks\x01@\0\0\x05\x04\0\x0fget-initial-\
cwd\x01\x06\x03\0(wasi:cli/environment@0.3.0-rc-2026-02-09\x05\0\x01B\x03\x01j\0\
\0\x01@\x01\x06status\0\x01\0\x04\0\x04exit\x01\x01\x03\0!wasi:cli/exit@0.3.0-rc\
...
ure-random-u64\x01\x02\x03\0(wasi:random/insecure@0.3.0-rc-2026-02-09\x05\x1a\x01\
B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insecure-seed\x01\x01\x03\0-wasi:random\
/insecure-seed@0.3.0-rc-2026-02-09\x05\x1b\x04\0Dwasi:cli/command-with-all-of-it\
s-exports-removed@0.3.0-rc-2026-02-09\x04\0\x0b-\x01\0'command-with-all-of-its-e\
xports-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x07\
0.245.0\x10wit-bindgen-rust\x060.53.0";
#[inline(never)]
#[doc(hidden)]
