...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.45.0:wasi:cli@0.3.0-rc-2025-08-15:command:imports and exportsrust-wasi-from-crates-io-command-world")]
...
ucers\x01\x0cprocessed-by\x02\x0dwit-component\x070.238.0\x10wit-bindgen-rust\x06\
0.45.0";
        };
    };
}
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.45.0:wasi:cli@0.3.0-rc-2025-08-15:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"
)]
#[doc(hidden)]
...
mponent\x070.238.0\x10wit-bindgen-rust\x060.45.0";
#[inline(never)]
#[doc(hidden)]
