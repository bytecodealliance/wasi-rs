...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.53.0:wasi:cli@0.3.0-rc-2026-02-09:command:imports and exportsrust-wasip3-0.4.0+wasi-0.3.0-rc-2026-01-06-from-crates-io-command-world")]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.53.0:wasi:cli@0.3.0-rc-2026-02-09:command-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.4.0+wasi-0.3.0-rc-2026-01-06-from-crates-io-command-world"
)]
#[doc(hidden)]
