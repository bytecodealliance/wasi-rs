...
//   * type_section_suffix: "rust-wasip3-0.9.0+wasi-0.3.0-from-crates-io-service-world"
...
pub mod wasi {
    pub mod http {
        ...
        pub mod types {
            ...
            impl Fields {
                ...
                pub fn get_and_delete(
                    &self,
                    name: &str,
                ) -> ::core::result::Result<_rt::Vec<FieldValue>, HeaderError> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
            ...
            impl Request {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_scheme(&self) -> ::core::option::Option<Scheme> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
            ...
            impl Request {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_authority(&self) -> ::core::option::Option<_rt::String> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
            ...
            impl Request {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_options(&self) -> ::core::option::Option<RequestOptions> {
                    unsafe {
                        #[repr(align(4))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
                        let mut ret_area = RetArea(
            ...
            impl RequestOptions {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_connect_timeout(&self) -> ::core::option::Option<Duration> {
                    unsafe {
                        #[repr(align(8))]
            ...
            impl RequestOptions {
                ...
                ) -> ::core::result::Result<(), RequestOptionsError> {
                    unsafe {
                        #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                        #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                        struct RetArea(
            ...
            impl RequestOptions {
                ...
                #[allow(async_fn_in_trait)]
                pub fn get_first_byte_timeout(
                    &self,
                ) -> ::core::option::Option<Duration> {
                    unsafe {
                        #[repr(align(8))]
                        struct RetArea([::core::mem::MaybeUninit<u8>; 16]);
                        let mut ret_area = RetArea(
            ...
            impl RequestOptions {
                ...
                /// body stream.
                #[allow(async_fn_in_trait)]
                pub fn get_between_bytes_timeout(
                    &self,
                ) -> ::core::option::Option<Duration> {
                    unsafe {
                        #[repr(align(8))]
        ...
        pub mod client {
            ...
            pub async fn send(
                request: Request,
            ) -> ::core::result::Result<Response, ErrorCode> {
                unsafe {
                    #[derive(Copy, Clone)]
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        type Params = (Request,);
                        type Results = ::core::result::Result<Response, ErrorCode>;
...
pub mod wit_future {
    ...
    pub mod vtable0 {
        ...
        unsafe fn lift(
            ...
            ::core::option::Option<super::super::wasi::http::types::Trailers>,
    ...
    pub mod vtable1 {
        ...
        unsafe fn lift(
            ptr: *mut u8,
        ) -> ::core::result::Result<(), super::super::wasi::http::types::ErrorCode> {
            unsafe {
                let l0 = i32::from(*ptr.add(0).cast::<u8>());
                match l0 {
                    0 => {
        ...
        impl super::FuturePayload
        for ::core::result::Result<(), super::super::wasi::http::types::ErrorCode> {
            const VTABLE: &'static wit_bindgen::rt::async_support::FutureVtable<Self> = &VTABLE;
        }
    }
...
macro_rules! __export_service_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.62.0:wasi:http@0.3.0:service:imports and exportsrust-wasip3-0.9.0+wasi-0.3.0-from-crates-io-service-world")]
...
nt\x070.259.0\x10wit-bindgen-rust\x060.62.0";
        };
    };
}
#[doc(inline)]
...
#[cfg_attr(feature = "rustc-dep-of-std", unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:http@0.3.0:service-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.9.0+wasi-0.3.0-from-crates-io-service-world-in-libstd"))]
#[cfg_attr(not(feature = "rustc-dep-of-std"), unsafe(link_section = "component-type:wit-bindgen:0.62.0:wasi:http@0.3.0:service-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.9.0+wasi-0.3.0-from-crates-io-service-world"))]
