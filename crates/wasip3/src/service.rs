...
// Options used:
//   * with "wasi:cli/stdin@0.3.0-rc-2026-02-09" = "crate::cli::stdin"
//   * with "wasi:cli/stdout@0.3.0-rc-2026-02-09" = "crate::cli::stdout"
//   * with "wasi:cli/stderr@0.3.0-rc-2026-02-09" = "crate::cli::stderr"
//   * with "wasi:cli/types@0.3.0-rc-2026-02-09" = "crate::cli::types"
//   * with "wasi:clocks/monotonic-clock@0.3.0-rc-2026-02-09" = "crate::clocks::monotonic_clock"
//   * with "wasi:clocks/system-clock@0.3.0-rc-2026-02-09" = "crate::clocks::system_clock"
//   * with "wasi:clocks/types@0.3.0-rc-2026-02-09" = "crate::clocks::types"
//   * with "wasi:random/random@0.3.0-rc-2026-02-09" = "crate::random::random"
//   * with "wasi:random/insecure@0.3.0-rc-2026-02-09" = "crate::random::insecure"
//   * with "wasi:random/insecure-seed@0.3.0-rc-2026-02-09" = "crate::random::insecure_seed"
//   * type_section_suffix: "rust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-service-world"
        ...
        pub mod types {
            ...
            unsafe impl _rt::WasmResource for Fields {
                ...
                unsafe fn drop(_handle: u32) {
                    ...
                    #[link(wasm_import_module = "wasi:http/types@0.3.0-rc-2026-02-09")]
                    unsafe extern "C" {
            ...
            impl Fields {
                ...
                pub fn new() -> Self {
                    unsafe {
                        #[cfg(target_arch = "wasm32")]
                        #[link(
                            wasm_import_module = "wasi:http/types@0.3.0-rc-2026-02-09"
                        )]
                        unsafe extern "C" {
                ...
                unsafe {
                    ...
                    unsafe impl<'a> _Subtask for _MySubtask<'a> {
                        ...
                        unsafe fn call_import(
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "wasi:http/client@0.3.0-rc-2026-02-09"
                            )]
                            unsafe extern "C" {
    ...
    pub mod wasi {
        pub mod http {
            ...
            pub mod handler {
                ...
                pub unsafe fn _export_handle_cabi<T: Guest>(arg0: i32) -> i32 {
                    unsafe {
                        ...
                        wit_bindgen::rt::async_support::start_task(async move {
                            ...
                            #[cfg(target_arch = "wasm32")]
                            #[link(
                                wasm_import_module = "[export]wasi:http/handler@0.3.0-rc-2026-02-09"
                            )]
                            unsafe extern "C" {
                ...
                #[doc(hidden)]
                #[macro_export]
                macro_rules! __export_wasi_http_handler_0_3_0_rc_2026_02_09_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[unsafe (export_name =
                        "[async-lift]wasi:http/handler@0.3.0-rc-2026-02-09#handle")]
                        unsafe extern "C" fn export_handle(arg0 : i32,) -> i32 { unsafe {
                        $($path_to_types)*:: _export_handle_cabi::<$ty > (arg0) } }
                        #[unsafe (export_name =
                        "[callback][async-lift]wasi:http/handler@0.3.0-rc-2026-02-09#handle")]
                ...
                #[doc(hidden)]
                pub use __export_wasi_http_handler_0_3_0_rc_2026_02_09_cabi;
            }
        }
    }
}
...
macro_rules! __export_service_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::http::handler::__export_wasi_http_handler_0_3_0_rc_2026_02_09_cabi!($ty
        ...
        "component-type:wit-bindgen:0.53.0:wasi:http@0.3.0-rc-2026-02-09:service:imports and exportsrust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-service-world")]
        #[doc(hidden)] #[allow(clippy::octal_escapes)] pub static
        __WIT_BINDGEN_COMPONENT_TYPE : [u8; 5149] = *
        b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\x9f'\x01A\x02\x01A\x1f\
\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\
\0\0\x03\0\"wasi:cli/types@0.3.0-rc-2026-02-09\x05\0\x02\x03\0\0\x0aerror-code\x01\
...
i:cli/stdout@0.3.0-rc-2026-02-09\x05\x02\x01B\x07\x02\x03\x02\x01\x01\x04\0\x0ae\
rror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01e\x01\x03\x01@\x01\x04data\x02\0\x04\
\x04\0\x10write-via-stream\x01\x05\x03\0#wasi:cli/stderr@0.3.0-rc-2026-02-09\x05\
...
\x03\0\"wasi:cli/stdin@0.3.0-rc-2026-02-09\x05\x04\x01B\x02\x01w\x04\0\x08durati\
on\x03\0\0\x03\0%wasi:clocks/types@0.3.0-rc-2026-02-09\x05\x05\x02\x03\0\x04\x08\
...
\0\x0einternal-error\x01\x06\0\x04\0\x0aerror-code\x03\0\x12\x01q\x03\x0einvalid\
-syntax\0\0\x09forbidden\0\0\x09immutable\0\0\x04\0\x0cheader-error\x03\0\x14\x01\
q\x02\x0dnot-supported\0\0\x09immutable\0\0\x04\0\x15request-options-error\x03\0\
\x16\x01s\x04\0\x0afield-name\x03\0\x18\x01p}\x04\0\x0bfield-value\x03\0\x1a\x04\
\0\x06fields\x03\x01\x04\0\x07headers\x03\0\x1c\x04\0\x08trailers\x03\0\x1c\x04\0\
\x07request\x03\x01\x04\0\x0frequest-options\x03\x01\x01{\x04\0\x0bstatus-code\x03\
\0!\x04\0\x08response\x03\x01\x01i\x1c\x01@\0\0$\x04\0\x13[constructor]fields\x01\
%\x01o\x02\x19\x1b\x01p&\x01j\x01$\x01\x15\x01@\x01\x07entries'\0(\x04\0\x18[sta\
tic]fields.from-list\x01)\x01h\x1c\x01p\x1b\x01@\x02\x04self*\x04name\x19\0+\x04\
\0\x12[method]fields.get\x01,\x01@\x02\x04self*\x04name\x19\0\x7f\x04\0\x12[meth\
od]fields.has\x01-\x01j\0\x01\x15\x01@\x03\x04self*\x04name\x19\x05value+\0.\x04\
\0\x12[method]fields.set\x01/\x01@\x02\x04self*\x04name\x19\0.\x04\0\x15[method]\
fields.delete\x010\x01j\x01+\x01\x15\x01@\x02\x04self*\x04name\x19\01\x04\0\x1d[\
method]fields.get-and-delete\x012\x01@\x03\x04self*\x04name\x19\x05value\x1b\0.\x04\
\0\x15[method]fields.append\x013\x01@\x01\x04self*\0'\x04\0\x17[method]fields.co\
py-all\x014\x01@\x01\x04self*\0$\x04\0\x14[method]fields.clone\x015\x01i\x1d\x01\
f\x01}\x01k7\x01i\x1e\x01k9\x01j\x01:\x01\x13\x01e\x01;\x01i\x20\x01k=\x01i\x1f\x01\
j\0\x01\x13\x01e\x01\xc0\0\x01o\x02?\xc1\0\x01@\x04\x07headers6\x08contents8\x08\
trailers<\x07options>\0\xc2\0\x04\0\x13[static]request.new\x01C\x01h\x1f\x01@\x01\
\x04self\xc4\0\0\x03\x04\0\x1a[method]request.get-method\x01E\x01j\0\0\x01@\x02\x04\
self\xc4\0\x06method\x03\0\xc6\0\x04\0\x1a[method]request.set-method\x01G\x01@\x01\
...
\0\06\x04\0\x1b[method]request.get-headers\x01O\x01o\x027<\x01@\x02\x04this?\x03\
res\xc1\0\0\xd0\0\x04\0\x1c[static]request.consume-body\x01Q\x01@\0\0=\x04\0\x1c\
[constructor]request-options\x01R\x01h\x20\x01k\x01\x01@\x01\x04self\xd3\0\0\xd4\
\0\x04\0+[method]request-options.get-connect-timeout\x01U\x01j\0\x01\x17\x01@\x02\
\x04self\xd3\0\x08duration\xd4\0\0\xd6\0\x04\0+[method]request-options.set-conne\
ct-timeout\x01W\x04\0.[method]request-options.get-first-byte-timeout\x01U\x04\0.\
[method]request-options.set-first-byte-timeout\x01W\x04\01[method]request-option\
s.get-between-bytes-timeout\x01U\x04\01[method]request-options.set-between-bytes\
-timeout\x01W\x01@\x01\x04self\xd3\0\0=\x04\0\x1d[method]request-options.clone\x01\
X\x01i#\x01o\x02\xd9\0\xc1\0\x01@\x03\x07headers6\x08contents8\x08trailers<\0\xda\
\0\x04\0\x14[static]response.new\x01[\x01h#\x01@\x01\x04self\xdc\0\0\"\x04\0\x20\
[method]response.get-status-code\x01]\x01@\x02\x04self\xdc\0\x0bstatus-code\"\0\xc6\
\0\x04\0\x20[method]response.set-status-code\x01^\x01@\x01\x04self\xdc\0\06\x04\0\
\x1c[method]response.get-headers\x01_\x01@\x02\x04this\xd9\0\x03res\xc1\0\0\xd0\0\
\x04\0\x1d[static]response.consume-body\x01`\x03\0#wasi:http/types@0.3.0-rc-2026\
-02-09\x05\x07\x02\x03\0\x05\x07request\x02\x03\0\x05\x08response\x02\x03\0\x05\x0a\
error-code\x01B\x0b\x02\x03\x02\x01\x08\x04\0\x07request\x03\0\0\x02\x03\x02\x01\
\x09\x04\0\x08response\x03\0\x02\x02\x03\x02\x01\x0a\x04\0\x0aerror-code\x03\0\x04\
\x01i\x01\x01i\x03\x01j\x01\x07\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x04s\
end\x01\x09\x03\0$wasi:http/client@0.3.0-rc-2026-02-09\x05\x0b\x01B\x0c\x02\x03\x02\
\x01\x06\x04\0\x08duration\x03\0\0\x01w\x04\0\x04mark\x03\0\x02\x01@\0\0\x03\x04\
\0\x03now\x01\x04\x01@\0\0\x01\x04\0\x0eget-resolution\x01\x05\x01C\x01\x04when\x03\
\x01\0\x04\0\x0await-until\x01\x06\x01C\x01\x08how-long\x01\x01\0\x04\0\x08wait-\
for\x01\x07\x03\0/wasi:clocks/monotonic-clock@0.3.0-rc-2026-02-09\x05\x0c\x01B\x08\
\x02\x03\x02\x01\x06\x04\0\x08duration\x03\0\0\x01r\x02\x07secondsx\x0bnanosecon\
dsy\x04\0\x07instant\x03\0\x02\x01@\0\0\x03\x04\0\x03now\x01\x04\x01@\0\0\x01\x04\
\0\x0eget-resolution\x01\x05\x03\0,wasi:clocks/system-clock@0.3.0-rc-2026-02-09\x05\
\x0d\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10get-random-bytes\x01\x01\x01@\0\
\0w\x04\0\x0eget-random-u64\x01\x02\x03\0&wasi:random/random@0.3.0-rc-2026-02-09\
\x05\x0e\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x19get-insecure-random-bytes\x01\
\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\0(wasi:random/insecu\
re@0.3.0-rc-2026-02-09\x05\x0f\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insec\
ure-seed\x01\x01\x03\0-wasi:random/insecure-seed@0.3.0-rc-2026-02-09\x05\x10\x01\
B\x0b\x02\x03\x02\x01\x08\x04\0\x07request\x03\0\0\x02\x03\x02\x01\x09\x04\0\x08\
response\x03\0\x02\x02\x03\x02\x01\x0a\x04\0\x0aerror-code\x03\0\x04\x01i\x01\x01\
i\x03\x01j\x01\x07\x01\x05\x01C\x01\x07request\x06\0\x08\x04\0\x06handle\x01\x09\
\x04\0%wasi:http/handler@0.3.0-rc-2026-02-09\x05\x11\x04\0%wasi:http/service@0.3\
.0-rc-2026-02-09\x04\0\x0b\x0d\x01\0\x07service\x03\0\0\0G\x09producers\x01\x0cp\
rocessed-by\x02\x0dwit-component\x070.245.0\x10wit-bindgen-rust\x060.53.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.53.0:wasi:http@0.3.0-rc-2026-02-09:service-with-all-of-its-exports-removed:encoded worldrust-wasip3-0.5.0+wasi-0.3.0-rc-2026-02-09-from-crates-io-service-world"
)]
#[doc(hidden)]
#[allow(clippy::octal_escapes)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 5073] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xb3&\x01A\x02\x01A\x1d\
\x01B\x02\x01m\x03\x02io\x15illegal-byte-sequence\x04pipe\x04\0\x0aerror-code\x03\
\0\0\x03\0\"wasi:cli/types@0.3.0-rc-2026-02-09\x05\0\x02\x03\0\0\x0aerror-code\x01\
B\x07\x02\x03\x02\x01\x01\x04\0\x0aerror-code\x03\0\0\x01f\x01}\x01j\0\x01\x01\x01\
e\x01\x03\x01@\x01\x04data\x02\0\x04\x04\0\x10write-via-stream\x01\x05\x03\0#was\
...
\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\0(wasi:random/insecu\
re@0.3.0-rc-2026-02-09\x05\x0f\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x11get-insec\
ure-seed\x01\x01\x03\0-wasi:random/insecure-seed@0.3.0-rc-2026-02-09\x05\x10\x04\
\0Ewasi:http/service-with-all-of-its-exports-removed@0.3.0-rc-2026-02-09\x04\0\x0b\
-\x01\0'service-with-all-of-its-exports-removed\x03\0\0\0G\x09producers\x01\x0cp\
rocessed-by\x02\x0dwit-component\x070.245.0\x10wit-bindgen-rust\x060.53.0";
#[inline(never)]
#[doc(hidden)]
