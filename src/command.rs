            ...
            pub mod run {
                ...
                macro_rules! __export_wasi_cli_run_0_2_1_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        const _ : () = { #[export_name = "wasi:cli/run@0.2.1#run"] unsafe
                        extern "C" fn export_run() -> i32 { $($path_to_types)*::
                        _export_run_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
                pub use __export_wasi_cli_run_0_2_1_cabi;
            }
        }
    }
}
...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::wasi::cli::run::__export_wasi_cli_run_0_2_1_cabi!($ty with_types_in
        $($path_to_types_root)*:: exports::wasi::cli::run); const _ : () = {
        #[cfg(target_arch = "wasm32")] #[link_section =
        "component-type:wit-bindgen:0.29.0:command:imports and exportsrust-wasi-from-crates-io-command-world"]
...
\x06\x03\x01\x1awasi:cli/environment@0.2.1\x05\0\x01B\x03\x01j\0\0\x01@\x01\x06s\
tatus\0\x01\0\x04\0\x04exit\x01\x01\x03\x01\x13wasi:cli/exit@0.2.1\x05\x01\x01B\x04\
\x04\0\x05error\x03\x01\x01h\0\x01@\x01\x04self\x01\0s\x04\0\x1d[method]error.to\
-debug-string\x01\x02\x03\x01\x13wasi:io/error@0.2.1\x05\x02\x01B\x0a\x04\0\x08p\
...
ll@0.2.1\x05\x03\x02\x03\0\x02\x05error\x02\x03\0\x03\x08pollable\x01B(\x02\x03\x02\
...
\x18\x03\x01\x15wasi:io/streams@0.2.1\x05\x06\x02\x03\0\x04\x0cinput-stream\x01B\
\x05\x02\x03\x02\x01\x07\x04\0\x0cinput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\x04\
\0\x09get-stdin\x01\x03\x03\x01\x14wasi:cli/stdin@0.2.1\x05\x08\x02\x03\0\x04\x0d\
output-stream\x01B\x05\x02\x03\x02\x01\x09\x04\0\x0doutput-stream\x03\0\0\x01i\x01\
\x01@\0\0\x02\x04\0\x0aget-stdout\x01\x03\x03\x01\x15wasi:cli/stdout@0.2.1\x05\x0a\
\x01B\x05\x02\x03\x02\x01\x09\x04\0\x0doutput-stream\x03\0\0\x01i\x01\x01@\0\0\x02\
\x04\0\x0aget-stderr\x01\x03\x03\x01\x15wasi:cli/stderr@0.2.1\x05\x0b\x01B\x01\x04\
\0\x0eterminal-input\x03\x01\x03\x01\x1dwasi:cli/terminal-input@0.2.1\x05\x0c\x01\
B\x01\x04\0\x0fterminal-output\x03\x01\x03\x01\x1ewasi:cli/terminal-output@0.2.1\
...
\x01\x04\x03\x01\x1dwasi:cli/terminal-stdin@0.2.1\x05\x0f\x02\x03\0\x09\x0ftermi\
...
terminal-stdout@0.2.1\x05\x11\x01B\x06\x02\x03\x02\x01\x10\x04\0\x0fterminal-out\
put\x03\0\0\x01i\x01\x01k\x02\x01@\0\0\x03\x04\0\x13get-terminal-stderr\x01\x04\x03\
\x01\x1ewasi:cli/terminal-stderr@0.2.1\x05\x12\x01B\x0f\x02\x03\x02\x01\x05\x04\0\
...
-clock@0.2.1\x05\x13\x01B\x05\x01r\x02\x07secondsw\x0bnanosecondsy\x04\0\x08date\
time\x03\0\0\x01@\0\0\x01\x04\0\x03now\x01\x02\x04\0\x0aresolution\x01\x02\x03\x01\
\x1cwasi:clocks/wall-clock@0.2.1\x05\x14\x02\x03\0\x04\x05error\x02\x03\0\x0e\x08\
...
wasi:filesystem/types@0.2.1\x05\x17\x02\x03\0\x0f\x0adescriptor\x01B\x07\x02\x03\
...
address\x03\0\x0f\x03\x01\x1awasi:sockets/network@0.2.1\x05\x1a\x02\x03\0\x11\x07\
network\x01B\x05\x02\x03\x02\x01\x1b\x04\0\x07network\x03\0\0\x01i\x01\x01@\0\0\x02\
\x04\0\x10instance-network\x01\x03\x03\x01#wasi:sockets/instance-network@0.2.1\x05\
...
dp@0.2.1\x05\x20\x02\x03\0\x13\x0audp-socket\x01B\x0c\x02\x03\x02\x01\x1b\x04\0\x07\
...
create-udp-socket\x01\x0a\x03\x01$wasi:sockets/udp-create-socket@0.2.1\x05\"\x02\
...
\x01\x16wasi:sockets/tcp@0.2.1\x05$\x02\x03\0\x15\x0atcp-socket\x01B\x0c\x02\x03\
...
eate-socket@0.2.1\x05&\x02\x03\0\x11\x0aip-address\x01B\x16\x02\x03\x02\x01\x05\x04\
...
p-name-lookup@0.2.1\x05(\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x10get-random\
-bytes\x01\x01\x01@\0\0w\x04\0\x0eget-random-u64\x01\x02\x03\x01\x18wasi:random/\
random@0.2.1\x05)\x01B\x05\x01p}\x01@\x01\x03lenw\0\0\x04\0\x19get-insecure-rand\
om-bytes\x01\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\x01\x1aw\
asi:random/insecure@0.2.1\x05*\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x0dinsecure-\
seed\x01\x01\x03\x01\x1fwasi:random/insecure-seed@0.2.1\x05+\x01B\x03\x01j\0\0\x01\
@\0\0\0\x04\0\x03run\x01\x01\x04\x01\x12wasi:cli/run@0.2.1\x05,\x04\x01\x16wasi:\
cli/command@0.2.1\x04\0\x0b\x0d\x01\0\x07command\x03\0\0\0G\x09producers\x01\x0c\
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.29.0:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"]
#[doc(hidden)]
...
om-bytes\x01\x01\x01@\0\0w\x04\0\x17get-insecure-random-u64\x01\x02\x03\x01\x1aw\
asi:random/insecure@0.2.1\x05*\x01B\x03\x01o\x02ww\x01@\0\0\0\x04\0\x0dinsecure-\
seed\x01\x01\x03\x01\x1fwasi:random/insecure-seed@0.2.1\x05+\x04\x016wasi:cli/co\
mmand-with-all-of-its-exports-removed@0.2.1\x04\0\x0b-\x01\0'command-with-all-of\
-its-exports-removed\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-comp\
onent\x070.215.0\x10wit-bindgen-rust\x060.29.0";
#[inline(never)]
#[doc(hidden)]
#[cfg(target_arch = "wasm32")]
