            ...
            pub mod run {
                ...
                macro_rules! __export_wasi_cli_run_0_2_3_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        i32 { $($path_to_types)*:: _export_run_cabi::<$ty > () } };
                    };
                }
                #[doc(hidden)]
...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.39.0:wasi:cli@0.2.3:command:imports and exportsrust-wasi-from-crates-io-command-world")]
...
d\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.225.0\x10\
wit-bindgen-rust\x060.39.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.39.0:wasi:cli@0.2.3:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"
)]
#[doc(hidden)]
...
\x0cprocessed-by\x02\x0dwit-component\x070.225.0\x10wit-bindgen-rust\x060.39.0";
#[inline(never)]
#[doc(hidden)]
