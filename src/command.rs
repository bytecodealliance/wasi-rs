...
macro_rules! __export_command_impl {
  ...
  const _: () = {
    ...
    #[cfg(target_arch = "wasm32")]
    #[link_section = "component-type:wit-bindgen:0.20.0:command:imports and exportsrust-wasi-from-crates-io-command-world"]
    #[doc(hidden)]
...
onent\x070.201.0\x10wit-bindgen-rust\x060.20.0";
