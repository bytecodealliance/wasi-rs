...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.37.0:wasi:cli@0.2.3:command:imports and exportsrust-wasi-from-crates-io-command-world")]
...
d\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.223.0\x10\
wit-bindgen-rust\x060.37.0";
        };
    };
}
#[doc(inline)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.37.0:wasi:cli@0.2.3:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"
)]
#[doc(hidden)]
