...
macro_rules! __export_command_impl {
  ...
  const _: () = {
    ...
    #[cfg(target_arch = "wasm32")]
    #[link_section = "component-type:wit-bindgen:0.23.0:command:imports and exportsrust-wasi-from-crates-io-command-world"]
    #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.23.0:command-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-command-world"]
#[doc(hidden)]
...
onent\x070.202.0\x10wit-bindgen-rust\x060.23.0";
