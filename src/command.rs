...
macro_rules! __export_command_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        "component-type:wit-bindgen:0.44.0:wasi:cli@0.2.4:command:imports and exportsrust-wasi-from-crates-io-command-world")]
...
\x0cprocessed-by\x02\x0dwit-component\x070.238.0\x10wit-bindgen-rust\x060.44.0";
#[inline(never)]
#[doc(hidden)]
