...
macro_rules! __export_proxy_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        ...
        (link_section =
        "component-type:wit-bindgen:0.44.0:wasi:http@0.2.4:proxy:imports and exportsrust-wasi-from-crates-io-proxy-world")]
...
processed-by\x02\x0dwit-component\x070.238.0\x10wit-bindgen-rust\x060.44.0";
        };
    };
}
#[doc(inline)]
...
nent\x070.238.0\x10wit-bindgen-rust\x060.44.0";
#[inline(never)]
#[doc(hidden)]
