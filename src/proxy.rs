...
macro_rules! __export_proxy_impl {
  ...
  const _: () = {
    ...
    #[cfg(target_arch = "wasm32")]
    #[link_section = "component-type:wit-bindgen:0.23.0:proxy:imports and exportsrust-wasi-from-crates-io-proxy-world"]
    #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.23.0:proxy-with-all-of-its-exports-removed:encoded worldrust-wasi-from-crates-io-proxy-world"]
#[doc(hidden)]
...
wit-component\x070.202.0\x10wit-bindgen-rust\x060.23.0";
